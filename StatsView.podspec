#
#  Be sure to run `pod spec lint StatsView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Zheng-Xiang Ke"
  # s.authors            = { "Zheng-Xiang Ke" => "email@address.com" }
  # s.social_media_url   = "http://twitter.com/Zheng-Xiang Ke"
  ...
  s.source_files  = "StatsView/StatsView/**/*.swift"
